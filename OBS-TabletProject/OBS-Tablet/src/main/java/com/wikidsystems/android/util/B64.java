package com.wikidsystems.android.util;
...
/* ********  D E T E R M I N E   W H I C H   A L H A B E T  ******** */
    ...
    public static void main( String[] args )
    {
        if( args.length < 3 ){
            ...
            if( flag.equals( "-e" ) ){
                B64.encodeFileToFile( infile, outfile );
            }   // end if: encode
            else if( flag.equals( "-d" ) ) {
                B64.decodeFileToFile( infile, outfile );
            }   // end else if: decode    
            else {
...
/* ********  E N C O D I N G   M E T H O D S  ******** */    
     ...
     * @return The Base64-encoded object
     * @see com.wikidsystems.util.B64#GZIP
     * @see com.wikidsystems.util.B64#DONT_BREAK_LINES
     * @since 2.0
     */
...
//                log.debug(""+source[srcOffset+3]+  ": " + ( DECODABET[ source[ srcOffset + 3 ] ]  ) );
    ...
    /**
     * A {@link com.wikidsystems.util.B64.InputStream} will read data from another
     * <tt>java.io.InputStream</tt>, given in the constructor,
     * and encode/decode to/from Base64 notation on the fly.
     *
     * @see com.wikidsystems.util.B64
     * @since 1.3
     */
    public static class InputStream extends java.io.FilterInputStream
    {
        ...
        /**
         * Constructs a {@link com.wikidsystems.util.B64.InputStream} in DECODE mode.
         *
        ...
        /**
         * Constructs a {@link com.wikidsystems.util.B64.InputStream} in
         ...
         * @param in the <tt>java.io.InputStream</tt> from which to read data.
         * @param options Specified options
         * @see com.wikidsystems.util.B64#ENCODE
         * @see com.wikidsystems.util.B64#DECODE
         * @see com.wikidsystems.util.B64#DONT_BREAK_LINES
         * @since 2.0
         */
    ...
    /**
     * A {@link com.wikidsystems.util.B64.OutputStream} will write data to another
    ...
    public static class OutputStream extends java.io.FilterOutputStream
    {
        ...
        /**
         * Constructs a {@link com.wikidsystems.util.B64.OutputStream} in ENCODE mode.
         *
        ...
        /**
         * Constructs a {@link com.wikidsystems.util.B64.OutputStream} in
         * either ENCODE or DECODE mode.
         * <p>
         * Valid options:<pre>
         *   ENCODE or DECODE: Encode or Decode as data is read.
